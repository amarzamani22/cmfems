...
function render() {
  ...
  // Operator app: only pages operators actually use.
  const map = {
...
function buildNotifications() {
  ...
  // Due-soon jobs — surface ones approaching their due date/hour so admin/ops act before
  // they slip into overdue. Hour-based jobs are easy to miss without this signal because
  // the meter ticks up slowly between dashboard visits.
